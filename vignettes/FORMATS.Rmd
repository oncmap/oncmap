...
ECAP is the only format with Timezone included in the timestamp.
ADHERETECH has a separate column for Timezone `Patient_Timezone`
...
## ADHERETECH
*** FIXME: TZ present (column Patient_Timezone)
